...
declare namespace apiRTC {
    ...
    class UserAgent extends Observable {
        ...
        createStreamFromMediaStream(MediaStream:any): Promise<Stream>;
    ...
    class Stream extends Observable {
        ...
        addInDiv(divId: string, mediaEltId: string, style: object, muted: boolean): any;
        removeFromDiv(divId: string, mediaEltId: string): any;
    }
    ...
    class Session extends Observable {
        ...
        joinPointerSharingRoom(roomId:any): Promise<PointerSharingRoom>;
